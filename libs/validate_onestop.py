...
class onestop():
    ...
    def providers_reg():
        if request.method == "GET":
            return render_template('employer/providers_reg.html')
            ...
            ProviderNamedata={
                'type':'name',
                'field':' ProviderName',
                'errorname': 'ProviderName',
                'input': ProviderName_form
            }
            info.append(ProviderNamedata)
            addressdata={
                'type':'address',
                'field':'address',
                'errorname': 'address',
            ...
            BusinessNamedata={
                'type':'name',
                'field':'BusinessName',
                'errorname': 'BusinessName',
                'input': BusinessName_form
            }
            info.append(BusinessNamedata)
            CorporateNamedata={
                'type':'name',
                'field':'CorporateName',
                'errorname': 'CorporateName',
                'input': CorporateName_form
            }
            info.append(CorporateNamedata)
            einnumberdata={
                'type':'code',
                'field':'einnumber',
                'errorname': 'einnumber',
            ...
            Desiredpassworddata={
                'type':'password',
                'field':'Desiredpassword',
                'errorname': 'Desiredpassword',
                'input': DesiredPassword_form
            }
            info.append(Desiredpassworddata)
            Confirmpassworddata={
                'type':'password',
                'field':'password',
                'errorname': 'password',
    ...
    def code_title_add():
        if request.method == "GET":
            ...
            coursecodedata={
                ...
                'field': 'coursecode',
                'errorname': 'coursecode',
                'input': CourseCode_form
            }
            info.append(coursecodedata)
            coursetitledata={
                'type':'title',
                'field': 'coursetitle',
                'errorname': 'coursetitle',
                'input': Coursetitle_form
            }
            info.append(coursetitledata)
